    ...
    $.fn.richText = function(options) {
        ...
        var settings = $.extend({
                ...
                translations: {
                    ...
                    columns: "Columns",
                    add: "Adicionar",
                    pleaseEnterURL: "Ingrese URL",
                    videoURLnotSupported: "Video URL no supportado",
                    pleaseSelectImage: "Seleccione una imagen",
                    pleaseSelectFile: "Selecione un archivo",
                    bold: "Negrita",
                    italic: "Italica",
                    underline: "Delineado",
                    ...
                    addOrderedList: "Adicionar una lista ordenada",
                    addUnorderedList: "Adicionar una lista no ordenada",
                    addHeading: "Adicionar titulo",
                    addFont: "Adicionar tipo de letra",
                    addFontColor: "Color de letra",
                    addFontSize: "Tamaño de letra",
                    addImage: "Adicionar imagen",
                    addVideo: "Adicionar video",
                    addFile: "Adicionar archivo",
                    addURL: "Adicionar URL",
                    addTable: "Adicionar tabla",
        ...
        var $editor,
            ...
            $btnCode = $("<a />", {
                ...
                html: '<span class="fa fa-code"></span> <span class="fa fa-usd"></span><span class="fa fa-usd"></span>',
            }); // code
        ...
        $titles.append(
            $("<li />", {
                html: '<a data-command="formatBlock" data-option="h1">' +
        ...
        $titles.append(
            $("<li />", {
                html: '<a data-command="formatBlock" data-option="h2">' +
                    settings.translations.title +
                    " #2</a>",
            })
        );
        $titles.append(
            $("<li />", {
                html: '<a data-command="formatBlock" data-option="h3">' +
                    settings.translations.title +
                    " #3</a>",
            })
        );
        $titles.append(
            $("<li />", {
                html: '<a data-command="formatBlock" data-option="h4">' +
                    settings.translations.title +
                    " #4</a>",
            })
        );
        ...
        $editor.find(".richText-help").on("click", function() {
            ...
            if ($editor) {
                ...
                var $inner = $("<div />", {
                    style: "position:relative;margin:60px auto;padding:20px;background-color:#FAFAFA;width:70%;font-family:Georgia,Verdana,Helvetica,sans-serif;font-size:small;",
                });
                var $content = $("<div />", {
